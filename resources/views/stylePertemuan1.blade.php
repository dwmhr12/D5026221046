<html>
<head>
    <link rel="stylesheet" href="{{ asset('css/stylePertemuan1.css') }}">
    <style>
        h2 {
            color: greenyellow;
            text-align:center;
...
<body>
    ...
    <h3> title of paragraf </h3>
    <p> this is paragraf </p>
    <div class="kotaku1">hihihihihi</div>
    <div class="ratakanan" style="color:black;">xixixixi</div>
    <img src="{{ asset('gambar/HelloPertemuan1.jpeg') }}" class="fotolingkaran">
    <img src="{{ asset('gambar/HelloPertemuan1.jpeg') }}" class="fotorounded">
</body>
</html>